...
const Header = () => {
  ...
  return (
    <header className="bg-primary-green fixed top-0 py-2.5 w-full z-20">
      {/* <!-- navbar container --> */}
      <div className="w-full sm:w-full lg:w-12/12 px-1 sm:px-4 m-auto flex justify-between items-center relative">
