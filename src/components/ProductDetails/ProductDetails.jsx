                ...
                <>
                    ...
                    <main className="mt-12 sm:mt-0">
                        ...
                        <div className="w-full flex flex-col sm:flex-row bg-white sm:p-2 relative">
                            ...
                            {/* <!-- image wrapper --> */}
                            <div className="w-full sm:w-3/5 sm:sticky top-16 sm:h-screen">
                                {/* <!-- imgbox --> */}
                                <div className="flex flex-col gap-3 m-3">
                                    ...
                                    <div className="w-full flex gap-3">
                                        {/* <!-- add to cart btn --> */}
                                        {product.stock > 0 && (
                                            <button onClick={itemInCart ? goToCart : addToCartHandler} className="p-4 w-1/2 flex items-center justify-center gap-2 text-white bg-[purple] rounded-sm shadow hover:shadow-lg">
                                                <ShoppingCartIcon />
                                                {itemInCart ? "GO TO CART" : "ADD TO CART"}
                                            </button>
                                        )}
                                        <button onClick={buyNow} disabled={product.stock < 1 ? true : false} className={product.stock < 1 ? "p-4 w-full flex items-center justify-center gap-2 text-white bg-[#ee3c3c] cursor-not-allowed rounded-sm shadow hover:shadow-lg" : "p-4 w-1/2 flex items-center justify-center gap-2 text-white bg-[#262664] rounded-sm shadow hover:shadow-lg"}>
                                            <FlashOnIcon />
